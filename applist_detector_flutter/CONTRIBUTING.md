...
> If you want to ask a question, we assume that you have read the available [Documentation](https://github.com/AhmedAbouelkher/security_tester/tree/main/applist_detector_flutter).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/AhmedAbouelkher/security_tester/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/AhmedAbouelkher/security_tester/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/AhmedAbouelkher/security_tester/tree/main/applist_detector_flutter) carefully and find out if the functionality is already covered, maybe by an individual configuration.
